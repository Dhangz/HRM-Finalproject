        ...
        <div class="reports">
            ...
            <div class="col-md-4">
                ...
                <div class="header">
                    ...
                    <p class="category">Total Average of Employees Gender</p>     
                </div>
...
(COUNT(*) / (SELECT COUNT(*) FROM employees WHERE employee_id <> 0) * 100) as count_employee
FROM employees
...
<script>
    // <!-- setup block -->
    const count_employee = <?php echo json_encode($count_employee); ?>;
